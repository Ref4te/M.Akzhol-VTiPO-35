...
contract RockScissorPaper is VRFConsumerBaseV2Plus {
    ...
    function playRock() external payable { _play(0); }
    function playScissors() external payable { _play(1); }
    function playPaper() external payable { _play(2); }
